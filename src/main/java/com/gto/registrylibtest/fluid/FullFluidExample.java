 ...
 *
 * <p>涵盖：properties / fluidProperties / lang / clientExtension（3 参数着色） /
 * block（自定义配置）/ bucket（自定义配置）/ tag / removeTag / source / noBlock / noBucket。
 */
public class FullFluidExample {
    ...
    /**
     * 熔融铁：使用灰度纹理 + ARGB 着色，自定义 FluidType 物理属性、
