...
public class RegistryLibTest {
  ...
  public static final BlockEntry<Block> TEST_BLOCK =
      REGISTRYLIB.block(
          "test_block",
          Block::new,
          block -> {
  ...
  public static final BlockEntry<TimerBlock> ADVANCED_TIMER =
      REGISTRYLIB.block(
          "advanced_timer",
  ...
  public static final Group TIMER_GROUP =
      REGISTRYLIB
          .group("timers")
          .langPrefix("Timer")
  ...
  public static final BlockEntry<TimerBlock> TIMER_TIER_1 =
      TIMER_GROUP.block(
          "tier_1",
  ...
  static {
    REGISTRYLIB.addDataGenerator(
        ...
        adv -> {
          // --- Tab 1: Registry Basics (3 advancements) ---
          String cat1 = MOD_ID;
          ...
          AdvancementHolder root =
              Advancement.Builder.advancement()
                  .display(
                      TEST_ITEM.get(),
                      adv.title(cat1, "root", "Registry Basics"),
                      adv.desc(cat1, "root", "Getting started with RegistryLib"),
          ...
          AdvancementHolder advRoot =
              Advancement.Builder.advancement()
                  .display(
                      MAGIC_ORE.get().asItem(),
                      adv.title(cat1, "advanced/root", "Advanced Crafting"),
                      adv.desc(cat1, "advanced/root", "Explore advanced features of RegistryLib"),
                      Identifier.withDefaultNamespace(
