 ...
 *
 * <p>演示 <b>Approach 2</b>：通过 {@code block(parent, name, factory)} 的两参数形式，
 * 返回类型为 {@link com.gto.registrylibtest.builder.ModBlockBuilder}，
 * 直接调用 {@code .langCn()} 设置简体中文名称。
 * 注意：{@code .langCn()} 必须在任何 {@code BlockBuilder} 方法之前调用。
 */
