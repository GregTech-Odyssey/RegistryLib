  ...
  public void generateSlabBlock(
    ...
    TextureMapping textures =
        new TextureMapping()
            ...
            .put(TextureSlot.BOTTOM, bottom)
            .put(TextureSlot.TOP, top);
    MultiVariant slabTop =
        plainVariant(ModelTemplates.SLAB_TOP.create(block, textures, modelOutput));
    MultiVariant slabBottom =
        plainVariant(ModelTemplates.SLAB_BOTTOM.create(block, textures, modelOutput));
