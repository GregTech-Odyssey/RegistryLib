 ...
 * variants must be marked {@code @SyntaxSugar} instead. If you find that two methods for the
 * same feature both require {@code @StandardAPI}, consider whether the code structure needs
 * refactoring.
 *
 * <p>
