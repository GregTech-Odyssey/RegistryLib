...
public final class OneTimeEventReceiver<T extends Event> implements Consumer<T> {
    ...
    public static <T extends Event & IModBusEvent> void addModListener(
                                                                       RegistryCore owner, Class<? super T> evtClass, Consumer<? super T> listener) {
    ...
    public static void unregister(RegistryCore owner, Object listener, Class<? extends Event> event) {
        IEventBus bus = owner.getModEventBus();
        if (bus != null) {
