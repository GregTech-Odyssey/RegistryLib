...
See the [Custom Builder](../expert/custom-builder.md) tutorial for the full pattern.
...
- Combine with [Recipes and Tags](../intermediate/recipes-tags.md) datagen in the same registration chain for a complete single-chain setup.
...
- [Custom Builder](../expert/custom-builder.md) — Build your own Builder subclass with language helpers.
- [Recipes and Tags](../intermediate/recipes-tags.md) — Combine datagen with your registration chains.
- [API Reference](../../reference/api-overview.md) — Full API surface for `ProviderType` and `RegistryLibLangProvider`.
