...
**Shared defaults via Group:** When multiple items share a creative tab, lang prefix, or property modifiers, move shared setup into the [Group System](../tutorials/intermediate/group-system.md) instead of repeating it.

**Complex tooltips:** When tooltips include multiple sections or conditional visibility, move to the [Tooltip System](../tutorials/intermediate/tooltip-system.md) for structured rendering.
...
- [Tutorial: First Item](/tutorials/beginner/first-item)
- [Tutorial: Tooltip System](/tutorials/intermediate/tooltip-system)
