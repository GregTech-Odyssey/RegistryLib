...
**Shared properties via Group:** When multiple blocks share the same defaults (e.g., machine casings), centralize with the [Group System](../tutorials/intermediate/group-system.md) through `blockProperties(...)` or `itemProperties(...)`.

**BlockEntity later:** Keep block registration independent first, then attach BlockEntity behavior separately. See [Register Block Entities](./register-block-entities.md).

## See Also

- [Tutorial: First Block](/tutorials/beginner/first-block)
- [Tutorial: Group System](/tutorials/intermediate/group-system)
- [How-To: Register Block Entities](./register-block-entities.md)
