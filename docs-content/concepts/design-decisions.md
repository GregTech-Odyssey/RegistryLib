...
The [Group system](/tutorials/intermediate/group-system) lets you share defaults (lang prefix, creative tab, block properties, item properties, tags) across many entries without repeating them:
...
When you need a custom builder (e.g., a `MachineBlockBuilder` that adds machine-specific methods), RegistryLib uses [method overriding](/tutorials/expert/custom-builder):
...
:::tip
If you're unsure whether RegistryLib's approach fits your use case, start with the [beginner tutorials](/tutorials/beginner/installation). The fluent API is simpler to *use* than it is to *implement*, and most of the complexity lives in the internals you'll never touch.
:::

## See Also

- [Builder Pattern & Fluent API](../concepts/builder-pattern.md) — how the generic builder architecture works
- [Custom Builder](../tutorials/expert/custom-builder.md) — tutorial for creating your own builder type
- [Performance](../tutorials/expert/performance.md) — optimizations and performance considerations
