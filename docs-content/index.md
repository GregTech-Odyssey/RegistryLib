...
1. [Installation & Setup](/tutorials/beginner/installation) — Add the dependency and create your `RegistryCore`
2. [Your First Item](/tutorials/beginner/first-item) — Register a simple item
3. [Your First Block](/tutorials/beginner/first-block) — Register a block with a BlockItem
4. [Understanding the Chain](/tutorials/beginner/understanding-chain) — How the fluent API works

### I know the basics, show me more

Jump into **intermediate tutorials** for real-world patterns:

- [Group System](/tutorials/intermediate/group-system) — Share defaults across entries
- [Tooltip System](/tutorials/intermediate/tooltip-system) — Multi-section tooltips
- [Multi-Language Support](/tutorials/intermediate/multi-language) — Add extra locales
- [Recipes and Tags](/tutorials/intermediate/recipes-tags) — Datagen integration
...
|---|---|
| **Version** | 1.0.4 |
| **Minecraft** | 1.21+ (NeoForge 26.1) |
| **Java** | 21+ |
| **License** | See [LICENSE](https://github.com/GregTech-Odyssey/RegistryLib/blob/main/LICENSE) |
| **Source** | [GitHub](https://github.com/GregTech-Odyssey/RegistryLib) |
