...
const config = {
        ...
        links: [
          {
            title: 'Learn',
            items: [
              { label: 'Getting Started', to: '/tutorials/beginner/installation' },
  ...
  plugins: [
    [
      ...
      {
        redirects: [
          { from: '/quickstart', to: '/tutorials/beginner/installation' },
          ...
          { from: '/group-system', to: '/tutorials/intermediate/group-system' },
          { from: '/tooltip-system', to: '/tutorials/intermediate/tooltip-system' },
          { from: '/lang-system', to: '/tutorials/intermediate/multi-language' },
          { from: '/api-reference', to: '/reference/api-overview' },
          { from: '/override-builders', to: '/tutorials/expert/custom-builder' },
          { from: '/special-optimizations', to: '/tutorials/expert/performance' },
          { from: '/content-guides', to: '/how-to/register-items' },
          { from: '/systems-overview', to: '/concepts/what-is-registrylib' },
          { from: '/advanced-topics', to: '/tutorials/expert/custom-builder' },
        ],
      },
    ],
  ],
